...
public class RestaurantController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<Restaurant>> searchRestaurant(@RequestBody CreateRestaurantRequest req,
    ...
    public ResponseEntity<RestaurantDto> addToFavorites(@RequestBody CreateRestaurantRequest req,
    @RequestHeader("Authorization") String jwt, @PathVariable Long id)
     throws Exception{
        User user = userService.findUserByJwtToken(jwt);
